(function() {
  ...
  informant.defineElement("number", function(element) {
    ...
    var number = function(selection) {
      ...
      if (element.title()) {
        selection.append("div").classed("title", true).html(element.title());
      }
      value = selection.append("div").classed("value", true);
      if (element.description()) {
        selection.append("div").classed("description", true).html(element.description());
      }
